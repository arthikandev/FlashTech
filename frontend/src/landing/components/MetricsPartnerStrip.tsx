...
function LogoWebhooks() {
  return (
    <svg viewBox="0 0 24 24" className="h-[22px] w-[22px]" aria-hidden fill="none" stroke="currentColor">
      <path
        strokeWidth="1.75"
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M7.5 8.5 4.5 12l3 3.5M16.5 8.5 19.5 12l-3 3.5M14 6l-4 12"
      />
    </svg>
  );
}
...
const PARTNERS: Partner[] = [
  ...
  { name: "Webhooks", href: "#stack", Logo: LogoWebhooks },
