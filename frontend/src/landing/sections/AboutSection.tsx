...
export function AboutSection() {
  return (
    <section id="about" className="bg-black px-4 py-20 md:py-28 lg:py-32">
      <div className="max-w-6xl mx-auto bg-[#101010] rounded-2xl md:rounded-3xl px-6 py-14 md:px-16 md:py-20 text-center">
